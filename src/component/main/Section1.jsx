  ...
  return (
    <section className="s1_wrapper">
      <div className="left">
        ...
        <p>
          We bring you not only a stay option, but an experience in your budget
          to enjoy the luxury.
        </p>
        <div className="btn_wrapper">
          <button>Discover Now</button>
          <div className="wrapper">
            <div className="play_img_wrapper">
              <img
                src="https://booking.webestica.com/assets/images/avatar/12.jpg"
                alt=""
              />
            ...
            <span className="story">Watch Our Story</span>
          </div>
        </div>
      </div>
      <div className="right">
        ...
        <div className="right_allign_img">
        ...
        <div className="bottom_allign_img">
